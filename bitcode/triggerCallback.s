...
if.end:                                           ; preds = %entry
  ...
  store void (i8*, i32, i8*, %struct.__va_list_tag*)* %call, void (i8*, i32, i8*, %struct.__va_list_tag*)** @LLVMBind_triggerCallback, align 8
  br label %return
...
entry:
  ...
  %0 = load void (i8*, i32, i8*, %struct.__va_list_tag*)** @LLVMBind_triggerCallback, align 8
